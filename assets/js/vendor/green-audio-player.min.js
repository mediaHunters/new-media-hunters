          ...
          var a = (function () {
            function u(e, t) {
              ...
              this.audioPlayer.classList.add("green-audio-player"),
                ...
                (this.speaker =
                  this.audioPlayer.querySelector(".volume__speaker")),
              ...
              if (
                ...
                for (var n = 0; n < this.svg.length; n++)
                  this.svg[n].setAttribute("tabindex", 0),
                    this.svg[n].setAttribute("focusable", !0);
                for (var l = 0; l < this.img.length; l++)
                  this.img[l].setAttribute("tabindex", 0);
              } else
                for (var r = 0; r < this.span.length; r++)
                  this.span[r].outerHTML = "";
              if (
                (this.showTooltips &&
                ...
                void 0 !== o &&
                  o
                    .then(function () {
                      (a.player.parentElement.querySelector(
                        ".play-pause-btn__icon",
                      ).attributes.d.value = "M0 0h6v24H0zM12 0h6v24h-6z"),
                        a.playPauseBtn.setAttribute(
                          "aria-label",
                          a.labels.pause,
                        ),
                        a.hasSetAttribute(
              ...
              "preload" in this.player.attributes &&
                "none" === this.player.attributes.preload.value &&
              ...
              (t = [
                {
                  ...
                  value: function () {
                    ...
                    a.audioPlayer.addEventListener("mousedown", function (e) {
                      if (a.isDraggable(e.target)) {
                        ...
                        window.addEventListener("mousemove", i, !1),
                          a.currentlyDragged.parentElement.parentElement ===
                            a.sliders[0] &&
                            ((a.paused = a.player.paused),
                            !1 === a.paused && a.togglePlay()),
                          window.addEventListener(
                            "mouseup",
                            function () {
                              !1 !== a.currentlyDragged &&
                                a.currentlyDragged.parentElement
                                  .parentElement === a.sliders[0] &&
                                a.paused !== a.player.paused &&
                                a.togglePlay(),
                      ...
                      a.audioPlayer.addEventListener(
                        "touchstart",
                        function (e) {
                          if (a.isDraggable(e.target)) {
                      ...
                      this.playPauseBtn.addEventListener(
                        "click",
                        this.togglePlay.bind(a),
                      ),
                      this.player.addEventListener(
                        "timeupdate",
                        this.updateProgress.bind(a),
                      ),
                      this.player.addEventListener(
                        "volumechange",
                        this.updateVolume.bind(a),
                      ),
                      (this.player.volume = 0.81),
                      this.player.addEventListener(
                        "loadedmetadata",
                        function () {
                          a.totalTime.textContent = u.formatTime(
                            a.player.duration,
                          );
                        },
                      ),
                      this.player.addEventListener(
                        "seeking",
                        this.showLoadingIndicator.bind(a),
                      ),
                      this.player.addEventListener(
                        "seeked",
                        this.hideLoadingIndicator.bind(a),
                      ),
                      this.player.addEventListener(
                        "canplay",
                        this.hideLoadingIndicator.bind(a),
                      ...
                      this.volumeBtn.addEventListener(
                        "click",
                        this.showHideVolume.bind(a),
                      ),
                      window.addEventListener(
                        "resize",
                        a.directionAware.bind(a),
                      ),
                      window.addEventListener(
                        "scroll",
                        a.directionAware.bind(a),
                    ...
                    for (var e = 0; e < this.sliders.length; e++) {
                      ...
                      this.sliders[e].addEventListener(
                        "click",
                        a[t.dataset.method].bind(a),
                      );
                    }
                    this.downloadLink.addEventListener(
                      "click",
                      this.downloadAudio.bind(a),
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    for (var i = 0; i < this.draggableClasses.length; i++)
                      e.classList.contains(this.draggableClasses[i]) &&
                        (t = !0);
                    return t;
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    this.volumeProgress.setAttribute(
                      "aria-valuenow",
                      100 * this.player.volume,
                    ),
                      (this.volumeProgress.style.height = "".concat(
                        100 * this.player.volume,
                        "%",
                      )),
                      0.5 <= this.player.volume
                        ...
                        : this.player.volume < 0.5 && 0.05 < this.player.volume
                        ? (this.speaker.attributes.d.value =
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      ...
                      "touchmove" === e.type &&
                        (t = i.target.parentElement.parentElement),
                      t
                    );
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if ("horizontal" === i.dataset.direction)
                      a =
                        ((t ? e.touches[0].clientX : e.clientX) - s.left) /
                        s.width;
                    else if ("vertical" === i.dataset.direction) {
                      var n = s.height;
                      a =
                        1 -
                        ((t ? e.touches[0].clientY : e.clientY) - s.top) / n;
                    }
                    return a;
                  },
                },
                  ...
                  value: function (e) {
                    this.player.seekable &&
                      ...
                      (this.player.currentTime =
                        this.player.duration * this.getCoefficient(e));
                  },
                },
                {
                  key: "showVolume",
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.inRange(e) &&
                      (this.player.volume =
                        Math.round(50 * this.getCoefficient(e)) / 50);
                  },
                },
                {
                  key: "preloadNone",
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    !this.seeking ||
                      ...
                      (this.togglePlay(), (this.seeking = !1));
                  },
                },
                {
                  key: "pressKb",
                    ...
                    switch (t.keyCode) {
                      ...
                      case 39:
                        document.activeElement === this.sliders[0] &&
                          ...
                          !this.player.paused &&
                            this.player.seeking &&
                            (this.togglePlay(), (this.seeking = !0)));
                        break;
                      case 38:
                      case 40:
                        (document.activeElement.parentNode !== this.volumeBtn &&
                          ...
                          (38 === t.keyCode
                            ...
                            : this.setVolume(-0.05)),
                          document.activeElement.parentNode ===
                            this.volumeBtn && this.showVolume();
                    }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this.player.currentSrc,
                      t = e.split("/").reverse()[0];
                    this.downloadLink.setAttribute("href", e),
                      this.downloadLink.setAttribute("download", t);
                  },
                },
                {
                  key: "directionAware",
